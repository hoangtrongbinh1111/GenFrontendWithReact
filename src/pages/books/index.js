...
function Books(props) {
  ...
  const getData = () => {
    ...
    props.dispatch(BooksActions.getBooks(params, (res) => {
  ...
  const _handleUpdate = (values) => {
    setPending(true);
    props.dispatch(BooksActions.updateBooks(values, (res) => {
      setPending(false);
  ...
  const _handleDelete = (_id) => {
    props.dispatch(BooksActions.deleteBooks({ _id }, (res) => {
      getData();
      notification['success']({
  ...
  const _handleAdd = (values) => {
    setPending(true);
    props.dispatch(BooksActions.addBooks(values, (res) => {
      setPending(false);
      if (res.error) {
        notification['error']({
